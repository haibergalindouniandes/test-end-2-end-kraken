Feature: Iniciar una conversación
  ...
  Scenario: Como primer usuario inicio sesion y mandó un mensaje al usuario 2
    ...
    When I enter email "maestriaingenieriasoftware2022@gmail.com"
    And I wait for 2 seconds
    And I enter password "Zl@ifer619"
    And I wait for 2 seconds
    And I click next
  ...
  Scenario: Como usuario 2 inicio sesion y mandó un mensaje al usuario 1
    ...
    When I enter email "hgalindo.indra@gmail.com"
    And I wait for 2 seconds
    And I enter password "H@iber619"
    And I wait for 7 seconds
